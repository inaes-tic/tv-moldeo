...
moFunctionPanel::moFunctionPanel(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
	...
	StaticBitmap1 = new wxStaticBitmap(PanelPlot2d, ID_STATICBITMAP1, wxBitmap(wxImage(_T("D:\\_data\\proyectos\\SINESTESIA\\OPENSVN\\trunk\\0.7\\doc\\icons\\functiontest.png")).Rescale(wxSize(136,72).GetWidth(),wxSize(136,72).GetHeight())), wxPoint(0,8), wxSize(136,72), 0, _T("ID_STATICBITMAP1"));
