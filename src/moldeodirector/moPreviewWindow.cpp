...
moPreviewWindow::moPreviewWindow(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
	...
	BitmapButtonPlay = new wxBitmapButton(this, ID_BITMAPBUTTONPLAY, wxBitmap(wxImage(_T("../../art/icons/play32.png"))), wxPoint(0,300),  wxSize(40,40), wxBORDER_NONE | wxNO_BORDER , wxDefaultValidator, _T("ID_BITMAPBUTTONPLAY"));
	BitmapButtonPlay->SetDefault();
	BitmapButtonPlay->SetToolTip(_("Play"));
	BitmapButtonPlay->SetHelpText(_("Play"));
	BitmapButtonPause = new wxBitmapButton(this, ID_BITMAPBUTTONPAUSE, wxBitmap(wxImage(_T("../../art/icons/pause32.png"))), wxPoint(40,300),  wxSize(40,40), wxBORDER_NONE | wxNO_BORDER, wxDefaultValidator, _T("ID_BITMAPBUTTONPAUSE"));
	BitmapButtonPause->SetDefault();
	BitmapButtonPause->SetToolTip(_("Pause"));
	BitmapButtonPause->SetHelpText(_("Pause"));
	ButtonFullSCreen = new wxBitmapButton(this, ID_BITMAPBUTTONFULLSCREEN, wxBitmap(wxImage(_T("../../art/icons/fullscreen32.png"))), wxPoint(400-120,300), wxSize(40,40), wxBORDER_NONE | wxNO_BORDER, wxDefaultValidator, _T("ID_BITMAPBUTTONFULLSCREEN"));
	ButtonFullSCreen->SetDefault();
	ButtonFullSCreen->SetToolTip(_("Fullscreen"));
	ButtonFullSCreen->SetHelpText(_("Fullscreen"));
	BitmapButtonScreenshot = new wxBitmapButton(this, ID_BITMAPBUTTONSCREENSHOT, wxBitmap(wxImage(_T("../../art/icons/screenshot32.png"))), wxPoint(400-80,300),  wxSize(40,40), wxBORDER_NONE | wxNO_BORDER, wxDefaultValidator, _T("ID_BITMAPBUTTONSCREENSHOT"));
	...
	BitmapButtonSaveVideo = new wxBitmapButton(this, ID_BITMAPBUTTONSAVEVIDEO, wxBitmap(wxImage(_T("../../art/icons/savevideo32.png"))), wxPoint(400-40,300),  wxSize(40,40), wxBORDER_NONE | wxNO_BORDER, wxDefaultValidator, _T("ID_BITMAPBUTTONSAVEVIDEO"));
	BitmapButtonSaveVideo->SetDefault();
	BitmapButtonSaveVideo->SetToolTip(_("Movie"));
	BitmapButtonSaveVideo->SetHelpText(_("Movie"));
	BitmapButtonSaveSession = new wxBitmapButton(this, ID_BITMAPBUTTONSAVESESSION, wxBitmap(wxImage(_T("../../art/icons/savesession32.png"))), wxPoint(80,300),  wxSize(40,40), wxBORDER_NONE | wxNO_BORDER, wxDefaultValidator, _T("ID_BITMAPBUTTONSAVESESSION"));
	BitmapButtonSaveSession->SetToolTip(_("Record"));
	BitmapButtonSaveSession->SetHelpText(_("Record"));
	BitmapButtonStop = new wxBitmapButton(this, ID_BITMAPBUTTONSTOP, wxBitmap(wxImage(_T("../../art/icons/stop32.png"))), wxPoint(120,300),  wxSize(40,40), wxBORDER_NONE | wxNO_BORDER, wxDefaultValidator, _T("ID_BITMAPBUTTONSTOP"));
