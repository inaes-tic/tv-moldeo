...
class moFilesbook : public wxAuiNotebook, public moIDirectorActions {
	...
	public:
		...
		wxAuiNotebook(parent, id, pos, size, wxSP_NOBORDER | wxNO_BORDER | wxAUI_NB_TAB_SPLIT | wxAUI_NB_CLOSE_ON_ALL_TABS | wxAUI_NB_WINDOWLIST_BUTTON | wxAUI_NB_SCROLL_BUTTONS | wxAUI_NB_TAB_MOVE ) { }
