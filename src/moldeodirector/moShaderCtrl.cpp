...
moShaderCtrl::moShaderCtrl(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
	...
	BitmapButtonShaderSelect = new wxBitmapButton(this, ID_BITMAPBUTTONSHADERSELECT, wxBitmap(wxImage(_T("../../art/icons/select.png"))), wxPoint(120,0), wxSize(13,13), wxBU_AUTODRAW, wxDefaultValidator, _T("ID_BITMAPBUTTONSHADERSELECT"));
	BitmapButtonShaderSelect->SetDefault();
	BitmapButtonShaderImport = new wxBitmapButton(this, ID_BITMAPBUTTONSHADERIMPORT, wxBitmap(wxImage(_T("../../art/icons/import.png"))), wxPoint(104,0), wxSize(13,13), wxBU_AUTODRAW, wxDefaultValidator, _T("ID_BITMAPBUTTONSHADERIMPORT"));
