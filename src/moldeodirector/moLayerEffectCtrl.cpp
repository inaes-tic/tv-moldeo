...
moLayerEffectCtrl::moLayerEffectCtrl(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
	...
	CheckBoxOnOff->Hide();
	BitmapButtonView = new wxBitmapButton(this, ID_BITMAPBUTTONVIEW, wxBitmap(wxImage(_T("../../art/icons/view_16.png"))), wxPoint(0,2), wxSize(24,24), wxNO_BORDER, wxDefaultValidator, _T("ID_BITMAPBUTTONVIEW"));
  ...
  m_BitmapViewOn = wxBitmap( wxImage( _T("../../art/icons/view_16.png") ) );
  m_BitmapViewOff = wxBitmap( wxImage( _T("../../art/icons/view_16_off.png") ) );
