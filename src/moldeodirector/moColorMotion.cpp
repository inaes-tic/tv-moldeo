...
moColorMotion::moColorMotion(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
	...
	BitmapButton1 = new wxBitmapButton(Panel2, ID_BITMAPBUTTON1, wxBitmap(wxImage(_T("../../art/icons/pickcolor.png"))), wxPoint(160,172), wxSize(32,32), wxNO_BORDER, wxDefaultValidator, _T("ID_BITMAPBUTTON1"));
	BitmapButton1->SetDefault();
	BitmapButton1->SetForegroundColour(wxColour(255,255,255));
