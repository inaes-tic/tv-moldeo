...
//	p_s = SDL_CreateRGBSurface( 0, 160, 100, 24, 0, 0, 0, 0);
	...
	*/
	...
	imglist->Add( wxBitmap(wxImage(_T("../../art/icons/server_16.png"))) );  //0
	imglist->Add( wxBitmap(wxImage(_T("../../art/icons/server_edit_16.png"))) ); //1
	imglist->Add( wxBitmap(wxImage(_T("../../art/icons/view_16.png"))) );//2
	imglist->Add( wxBitmap(wxImage(_T("../../art/icons/sitemap_16.png"))) );//3
	imglist->Add( wxBitmap(wxImage(_T("../../art/icons/settings_16.png"))) );//4
	imglist->Add( wxBitmap(wxImage(_T("../../art/icons/relevance_16.png"))) );//5
