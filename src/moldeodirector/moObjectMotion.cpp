...
moObjectMotion::moObjectMotion(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
	...
	BitmapButtonPosCircular = new wxBitmapButton(Panel1, ID_BITMAPBUTTONPOSCIRCULAR, wxBitmap(wxImage(_T("D:\\_data\\proyectos\\SINESTESIA\\OPENSVN\\trunk\\0.7\\doc\\icons\\motioncircular.png"))), wxPoint(0,0), wxSize(32,32), wxBU_AUTODRAW, wxDefaultValidator, _T("ID_BITMAPBUTTONPOSCIRCULAR"));
	BitmapButtonPosCircular->SetDefault();
	BitmapButtonPosHor = new wxBitmapButton(Panel1, ID_BITMAPBUTTONPOSHOR, wxBitmap(wxImage(_T("D:\\_data\\proyectos\\SINESTESIA\\OPENSVN\\trunk\\0.7\\doc\\icons\\motionhorizontal.png"))), wxPoint(32,0), wxSize(32,32), wxBU_AUTODRAW, wxDefaultValidator, _T("ID_BITMAPBUTTONPOSHOR"));
	BitmapButtonPosHor->SetDefault();
	BitmapButtonPosVer = new wxBitmapButton(Panel1, ID_BITMAPBUTTONPOSVERT, wxBitmap(wxImage(_T("D:\\_data\\proyectos\\SINESTESIA\\OPENSVN\\trunk\\0.7\\doc\\icons\\motionvertical.png"))), wxPoint(64,0), wxSize(32,32), wxBU_AUTODRAW, wxDefaultValidator, _T("ID_BITMAPBUTTONPOSVERT"));
	BitmapButtonPosVer->SetDefault();
	BitmapButton8 = new wxBitmapButton(Panel1, ID_BITMAPBUTTON8, wxBitmap(wxImage(_T("D:\\_data\\proyectos\\SINESTESIA\\OPENSVN\\trunk\\0.7\\doc\\icons\\motiondiagonal.png"))), wxPoint(96,0), wxSize(32,32), wxBU_AUTODRAW, wxDefaultValidator, _T("ID_BITMAPBUTTON8"));
	BitmapButton8->SetDefault();
	BitmapButtonPosRand = new wxBitmapButton(Panel1, ID_BITMAPBUTTONPOSRAND, wxBitmap(wxImage(_T("D:\\_data\\proyectos\\SINESTESIA\\OPENSVN\\trunk\\0.7\\doc\\icons\\motionrandom.png"))), wxPoint(0,32), wxSize(32,32), wxBU_AUTODRAW, wxDefaultValidator, _T("ID_BITMAPBUTTONPOSRAND"));
	...
	BitmapButtonRotCircular = new wxBitmapButton(Panel3, ID_BITMAPBUTTONROTCIRCULAR, wxBitmap(wxImage(_T("D:\\_data\\proyectos\\SINESTESIA\\OPENSVN\\trunk\\0.7\\doc\\icons\\motioncircular.png"))), wxPoint(0,0), wxSize(32,32), wxBU_AUTODRAW, wxDefaultValidator, _T("ID_BITMAPBUTTONROTCIRCULAR"));
	BitmapButtonRotCircular->SetDefault();
	BitmapButtonRotHor = new wxBitmapButton(Panel3, ID_BITMAPBUTTONROTHOR, wxBitmap(wxImage(_T("D:\\_data\\proyectos\\SINESTESIA\\OPENSVN\\trunk\\0.7\\doc\\icons\\motionhorizontal.png"))), wxPoint(32,0), wxSize(32,32), wxBU_AUTODRAW, wxDefaultValidator, _T("ID_BITMAPBUTTONROTHOR"));
	BitmapButtonRotHor->SetDefault();
	BitmapButtonRotVer = new wxBitmapButton(Panel3, ID_BITMAPBUTTONROTVER, wxBitmap(wxImage(_T("D:\\_data\\proyectos\\SINESTESIA\\OPENSVN\\trunk\\0.7\\doc\\icons\\motionvertical.png"))), wxPoint(64,0), wxSize(32,32), wxBU_AUTODRAW, wxDefaultValidator, _T("ID_BITMAPBUTTONROTVER"));
	BitmapButtonRotVer->SetDefault();
	BitmapButtonRotDiag = new wxBitmapButton(Panel3, ID_BITMAPBUTTONROTDIAG, wxBitmap(wxImage(_T("D:\\_data\\proyectos\\SINESTESIA\\OPENSVN\\trunk\\0.7\\doc\\icons\\motiondiagonal.png"))), wxPoint(96,0), wxSize(32,32), wxBU_AUTODRAW, wxDefaultValidator, _T("ID_BITMAPBUTTONROTDIAG"));
	BitmapButtonRotDiag->SetDefault();
	BitmapButtonRotRand = new wxBitmapButton(Panel3, ID_BITMAPBUTTONROTRAND, wxBitmap(wxImage(_T("D:\\_data\\proyectos\\SINESTESIA\\OPENSVN\\trunk\\0.7\\doc\\icons\\motionrandom.png"))), wxPoint(0,32), wxSize(32,32), wxBU_AUTODRAW, wxDefaultValidator, _T("ID_BITMAPBUTTONROTRAND"));
	...
	BitmapButtonScaCircular = new wxBitmapButton(Panel7, ID_BITMAPBUTTONSCACIRCULAR, wxBitmap(wxImage(_T("D:\\_data\\proyectos\\SINESTESIA\\OPENSVN\\trunk\\0.7\\doc\\icons\\motioncircular.png"))), wxPoint(0,0), wxSize(32,32), wxBU_AUTODRAW, wxDefaultValidator, _T("ID_BITMAPBUTTONSCACIRCULAR"));
	BitmapButtonScaCircular->SetDefault();
	BitmapButtonScaHor = new wxBitmapButton(Panel7, ID_BITMAPBUTTONSCAHOR, wxBitmap(wxImage(_T("D:\\_data\\proyectos\\SINESTESIA\\OPENSVN\\trunk\\0.7\\doc\\icons\\motionhorizontal.png"))), wxPoint(32,0), wxSize(32,32), wxBU_AUTODRAW, wxDefaultValidator, _T("ID_BITMAPBUTTONSCAHOR"));
	BitmapButtonScaHor->SetDefault();
	BitmapButtonScaVer = new wxBitmapButton(Panel7, ID_BITMAPBUTTONSCAVER, wxBitmap(wxImage(_T("D:\\_data\\proyectos\\SINESTESIA\\OPENSVN\\trunk\\0.7\\doc\\icons\\motionvertical.png"))), wxPoint(64,0), wxSize(32,32), wxBU_AUTODRAW, wxDefaultValidator, _T("ID_BITMAPBUTTONSCAVER"));
	BitmapButtonScaVer->SetDefault();
	BitmapButtonScaDiag = new wxBitmapButton(Panel7, ID_BITMAPBUTTONSCADIAG, wxBitmap(wxImage(_T("D:\\_data\\proyectos\\SINESTESIA\\OPENSVN\\trunk\\0.7\\doc\\icons\\motiondiagonal.png"))), wxPoint(96,0), wxSize(32,32), wxBU_AUTODRAW, wxDefaultValidator, _T("ID_BITMAPBUTTONSCADIAG"));
	BitmapButtonScaDiag->SetDefault();
	BitmapButtonScaRand = new wxBitmapButton(Panel7, ID_BITMAPBUTTONSCARAND, wxBitmap(wxImage(_T("D:\\_data\\proyectos\\SINESTESIA\\OPENSVN\\trunk\\0.7\\doc\\icons\\motionrandom.png"))), wxPoint(0,32), wxSize(32,32), wxBU_AUTODRAW, wxDefaultValidator, _T("ID_BITMAPBUTTONSCARAND"));
