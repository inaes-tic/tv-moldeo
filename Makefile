...
DIST_COMMON = README $(am__configure_deps) $(srcdir)/Makefile.am \
	$(srcdir)/Makefile.in $(srcdir)/moldeo.pc.in \
...
VERSION = 0.7
abs_builddir = /home/xaiki/src/TV/moldeo
abs_srcdir = /home/xaiki/src/TV/moldeo
...
SUBDIRS = moldeo src plugins
pkgconfigdir = $(libdir)/pkgconfig
pkgconfig_DATA = moldeo.pc
all: all-recursive
...
$(am__aclocal_m4_deps):
moldeo.pc: $(top_builddir)/config.status $(srcdir)/moldeo.pc.in
